...
//
// Solidity: function getSignatureList(string dealId, string network) view returns((uint256,uint256,address,bool,bool,string[],address,uint256,uint256)[])
