...
func getBillHistoryList(walletAddress, limit, offset string) ([]*BillingResult, error) {
	finalSql := "select ep.address_from,ep.locked_fee,ep.deadline,ep.payload_cid,ep.lock_payment_time,ep.coin_type,eup.unlock_to_user_address,eup.unlock_to_user_amount,eup.unlock_time,'polygon' as network  " +
