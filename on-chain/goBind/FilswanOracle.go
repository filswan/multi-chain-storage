...
// SignHash is a paid mutator transaction binding the contract method 0x7a62ee6c.
//
// Solidity: function signHash(string dealId, string network, bytes32 voteKey) returns()
func (_FilswanOracle *FilswanOracleTransactor) SignHash(opts *bind.TransactOpts, dealId string, network string, voteKey [32]byte) (*types.Transaction, error) {
	return _FilswanOracle.contract.Transact(opts, "signHash", dealId, network, voteKey)
}

// SignHash is a paid mutator transaction binding the contract method 0x7a62ee6c.
//
// Solidity: function signHash(string dealId, string network, bytes32 voteKey) returns()
func (_FilswanOracle *FilswanOracleSession) SignHash(dealId string, network string, voteKey [32]byte) (*types.Transaction, error) {
	return _FilswanOracle.Contract.SignHash(&_FilswanOracle.TransactOpts, dealId, network, voteKey)
}

// SignHash is a paid mutator transaction binding the contract method 0x7a62ee6c.
//
// Solidity: function signHash(string dealId, string network, bytes32 voteKey) returns()
func (_FilswanOracle *FilswanOracleTransactorSession) SignHash(dealId string, network string, voteKey [32]byte) (*types.Transaction, error) {
	return _FilswanOracle.Contract.SignHash(&_FilswanOracle.TransactOpts, dealId, network, voteKey)
}
...
// FilterSignHash is a free log retrieval operation binding the contract event 0x6f15be93d68d13327ebce74ab6f2607c84383dc3138f8a99873c6266f7033c4f.
//
// Solidity: event SignHash(string dealId, string network, bytes32 voteKey)
...
// WatchSignHash is a free log subscription operation binding the contract event 0x6f15be93d68d13327ebce74ab6f2607c84383dc3138f8a99873c6266f7033c4f.
//
// Solidity: event SignHash(string dealId, string network, bytes32 voteKey)
...
// ParseSignHash is a log parse operation binding the contract event 0x6f15be93d68d13327ebce74ab6f2607c84383dc3138f8a99873c6266f7033c4f.
//
// Solidity: event SignHash(string dealId, string network, bytes32 voteKey)
