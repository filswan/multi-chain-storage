export default {
  ...
  metaSpace: {
    empty_prompt: 'You do not have any buckets yet !',
    empty_prompt_detail: 'Start to upload your files.',
    search_bucket: 'Search Buckets',
    ...
    pay_tip: '*By purchasing new buckets, you will increase the "avalible buckets" with current wallet address.',
    pay_tip1: '*Maxium number of buckets is 33.',
