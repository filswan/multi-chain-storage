...
* WID is generated after you upload a file by calling upload file API, it includes 2 parts
  ...
  - source file payload CID: generated by IPFS after uploading to IPFS server, such as `QmbeBMxC8yBk67xZYPhAgyUMuxCW6DZdfFPhGbt9WFva3q`
  - after upload a file, if the web API generates the above UUID and source file payload CID, then the WID will be `ccceb1c1-ba11-4c95-8e62-d375ea80b0c3QmbeBMxC8yBk67xZYPhAgyUMuxCW6DZdfFPhGbt9WFva3q`
## Modules
