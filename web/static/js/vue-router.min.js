...
t = this, e = function () {
    ...
    var e = {
        ...
        render: function (e, n) {
            var o = n.props,
                ...
                u = n.data;
            u.routerView = !0;
            for (var s = a.$createElement, c = o.name, p = a.$route, f = a._routerViewCache || (a._routerViewCache = {}), h = 0, l = !1; a && a._routerRoot !== a;) {
                var d = a.$vnode ? a.$vnode.data : {};
                d.routerView && h++, d.keepAlive && a._directInactive && a._inactive && (l = !0), a = a.$parent
            }
            if (u.routerViewDepth = h, l) {
                var v = f[c],
                    y = v && v.component;
                return y ? (v.configProps && r(y, u, v.route, v.configProps), s(y, u, i)) : s()
            }
            var m = p.matched[h],
                g = m && m.components[c];
    ...
    function g(t, e) {
        ...
        return r.length === n.length && r.every(function (r) {
            var n = t[r],
                o = e[r];
            return null == n || null == o ? n === o : "object" == typeof n && "object" == typeof o ? g(n, o) : String(n) === String(o)
        })
    }
    ...
    function _(t, e) {
        for (var r, n = [], o = 0, i = 0, a = "", u = e && e.delimiter || "/"; null != (r = C.exec(t));) {
            var s = r[0],
                c = r[1],
                p = r.index;
    ...
    function S(t, e) {
        for (var r = new Array(t.length), n = 0; n < t.length; n++) "object" == typeof t[n] && (r[n] = new RegExp("^(?:" + t[n].pattern + ")$", T(e)));
        return function (e, n) {
            for (var o = "", i = e || {}, a = (n || {}).pretty ? j : encodeURIComponent, u = 0; u < t.length; u++) {
                var s = t[u];
                if ("string" != typeof s) {
                    var c, p = i[s.name];
                    if (null == p) {
                    ...
                    if (x(p)) {
                        ...
                        for (var f = 0; f < p.length; f++) {
                            if (c = a(p[f]), !r[u].test(c)) throw new TypeError('Expected all "' + s.name + '" to match "' + s.pattern + '", but received `' + JSON.stringify(c) + "`");
                            o += (0 === f ? s.prefix : s.delimiter) + c
                        }
                    } else {
                        if (c = s.asterisk ? encodeURI(p).replace(/[?#]/g, function (t) {
                                return "%" + t.charCodeAt(0).toString(16).toUpperCase()
                            }) : a(p), !r[u].test(c)) throw new TypeError('Expected "' + s.name + '" to match "' + s.pattern + '", but received "' + c + '"');
                        o += s.prefix + c
                    }
                } else o += s
            }
    ...
    function q(t, e, r) {
        ...
        return n || (i = (f ? i.slice(0, -p.length) : i) + "(?:" + p + "(?=$))?"), i += o ? "$" : n && f ? "" : "(?=" + p + "|$)", P(new RegExp("^" + i, T(r)), e)
    }
    ...
    function U(t, e, r) {
        return x(e) || (r = e || r, e = []), r = r || {}, t instanceof RegExp ? function (t, e) {
            ...
            return P(new RegExp("(?:" + n.join("|") + ")", T(r)), e)
        }(t, e, r) : function (t, e, r) {
            return q(_(t, r), e, r)
        }(t, e, r)
    }
    R.parse = k, R.compile = E, R.tokensToFunction = A, R.tokensToRegExp = O;
    var I = Object.create(null);

    function M(t, e, r) {
        e = e || {};
        try {
            var n = I[t] || (I[t] = R.compile(t));
    ...
    function V(e, r, n, o) {
        ...
        if (i.name) {
            var a = (i = t({}, e)).params;
            return a && "object" == typeof a && (i.params = t({}, a)), i
        }
        if (!i.path && i.params && r) {
            (i = t({}, i))._normalized = !0;
            var u = t(t({}, r.params), i.params);
            if (r.name) i.name = r.name, i.params = u;
        ...
        var f = function (t) {
            ...
            h = r && r.path || "/",
            l = f.path ? w(f.path, h, n || i.append) : h,
            d = function (t, e, r) {
                void 0 === e && (e = {});
                var n, o = r || c;
                try {
                ...
                for (var i in e) {
                    var a = e[i];
                    n[i] = Array.isArray(a) ? a.map(s) : s(a)
                }
                return n
        ...
        z = {
            ...
            render: function (e) {
                var r = this,
                    ...
                    w = u.redirectedFrom ? h(null, V(u.redirectedFrom), null, n) : u;
                c[g] = m(o, w), c[y] = this.exact ? c[g] : function (t, e) {
                ...
                var b = c[g] ? this.ariaCurrentValue : null,
                    x = function (t) {
                        D(t) && (r.replace ? n.replace(a, N) : n.push(a, N))
                    },
                    R = {
                        click: D
                    };
                ...
                if ("a" === this.tag) k.on = R, k.attrs = {
                    ...
                    if (A) {
                        A.isStatic = !1;
                        var O = A.data = t({}, A.data);
                        for (var C in O.on = O.on || {}, O.on) {
                            var _ = O.on[C];
                            C in R && (O.on[C] = Array.isArray(_) ? _ : [_])
                        }
                        for (var j in R) j in O.on ? O.on[j].push(R[j]) : O.on[j] = x;
                        var S = A.data.attrs = t({}, A.data.attrs);
        ...
        t.forEach(function (t) {
            ! function t(e, r, n, o, i, a) {
                var u = o.path,
                    ...
                    p = function (t, e, r) {
                        return r || (t = t.replace(/\/$/, "")), "/" === t[0] ? t : null == e ? t : b(e.path + "/" + t)
                    }(u, i, c.strict);
    ...
    function X(t, e) {
        ...
        function a(t, r, a) {
            ...
            if (c) {
                ...
                return u.path = M(p.path, u.params), s(p, u, a)
            }
            if (u.path) {
                u.params = {};
                for (var l = 0; l < n.length; l++) {
                    var d = n[l],
                        v = o[d];
                    if (Y(v.regex, u.path, u.params)) return s(v, u, a)
                }
            }
            return s(null, u)
        }
        ...
        function u(t, r) {
            ...
            if ("string" == typeof o && (o = {
                    path: o
                }), !o || "object" != typeof o) return s(null, r);
            var u = o,
                c = u.name,
                p = u.path,
                f = r.query,
                l = r.hash,
                d = r.params;
            return f = u.hasOwnProperty("query") ? u.query : f, l = u.hasOwnProperty("hash") ? u.hash : l, d = u.hasOwnProperty("params") ? u.params : d, c ? (i[c], a({
                _normalized: !0,
                name: c,
                query: f,
                hash: l,
    ...
    function nt() {
        ...
        return n.key = tt(), window.history.replaceState(n, "", r), window.addEventListener("popstate", at),
            function () {
    ...
    var ht, lt = K && (-1 === (ht = window.navigator.userAgent).indexOf("Android 2.") && -1 === ht.indexOf("Android 4.0") || -1 === ht.indexOf("Mobile Safari") || -1 !== ht.indexOf("Chrome") || -1 !== ht.indexOf("Windows Phone")) && window.history && "function" == typeof window.history.pushState;
    ...
    function gt(t, e) {
        return bt(t, e, mt.redirected, 'Redirected when going from "' + t.fullPath + '" to "' + function (t) {
    ...
    function wt(t, e) {
        return bt(t, e, mt.cancelled, 'Navigation cancelled from "' + t.fullPath + '" to "' + e.fullPath + '" with a new navigation.')
    }
        ...
        return function (e, r, n) {
            ...
            At(t, function (t, e, r, u) {
                if ("function" == typeof t && void 0 === t.cid) {
                    o = !0, i++;
                    var s, c = _t(function (e) {
                            var o;
                            ((o = e).__esModule || Ct && "Module" === o[Symbol.toStringTag]) && (e = e.default), t.resolved = "function" == typeof e ? e : B.extend(e), r.components[u] = e, --i <= 0 && n()
                        }),
                        p = _t(function (t) {
    ...
    jt.prototype.listen = function (t) {
    ...
    }, jt.prototype.transitionTo = function (t, e, r) {
        var n, o = this;
        try {
        ...
        this.confirmTransition(n, function () {
            var t = o.current;
            o.updateRoute(n), e && e(n), o.ensureURL(), o.router.afterHooks.forEach(function (e) {
                e && e(n, t)
            }), o.ready || (o.ready = !0, o.readyCbs.forEach(function (t) {
                t(n)
            }))
        }, function (t) {
            r && r(t), t && !o.ready && (o.ready = !0, kt(t, mt.redirected) ? o.readyCbs.forEach(function (t) {
                t(n)
        ...
        var n, o, i = this,
            a = this.current,
            u = function (t) {
                !kt(t) && Rt(t) && (i.errorCbs.length ? i.errorCbs.forEach(function (e) {
                    e(t)
                }) : console.error(t)), r && r(t)
            },
            s = t.matched.length - 1,
            c = a.matched.length - 1;
        if (m(t, a) && s === c && t.matched[s] === a.matched[c]) return this.ensureURL(), u(((o = bt(n = a, t, mt.duplicated, 'Avoided redundant navigation to current location: "' + n.fullPath + '".')).name = "NavigationDuplicated", o));
        var p = function (t, e) {
        ...
        this.pending = t;
        var v = function (e, r) {
            if (i.pending !== t) return u(wt(a, t));
            try {
                e(t, a, function (e) {
                    !1 === e ? (i.ensureURL(!0), u(function (t, e) {
                        return bt(t, e, mt.aborted, 'Navigation aborted from "' + t.fullPath + '" to "' + e.fullPath + '" via a navigation guard.')
                    }(a, t))) : Rt(e) ? (i.ensureURL(!0), u(e)) : "string" == typeof e || "object" == typeof e && ("string" == typeof e.path || "string" == typeof e.name) ? (u(gt(a, t)), "object" == typeof e && e.replace ? i.replace(e) : i.push(e)) : r(e)
                })
            } catch (t) {
                u(t)
            }
    ...
    var $t = function (t) {
        ...
        return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.setupListeners = function () {
            ...
            this.transitionTo(t, function (t) {
                dt(b(n.base + t.fullPath)), ot(n.router, t, o, !1), e && e(t)
            }, r)
        }, e.prototype.replace = function (t, e, r) {
            var n = this,
                o = this.current;
            this.transitionTo(t, function (t) {
                vt(b(n.base + t.fullPath)), ot(n.router, t, o, !1), e && e(t)
            }, r)
        ...
        return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.setupListeners = function () {
            ...
            if (!(this.listeners.length > 0)) {
                var e = this.router.options.scrollBehavior,
                    r = lt && e;
                r && this.listeners.push(nt());
                var n = function () {
                        var e = t.current;
                        qt() && t.transitionTo(Ut(), function (n) {
                            r && ot(t.router, n, e, !0), lt || Vt(n.fullPath)
                        })
                    },
            ...
            var n = this,
                o = this.current;
            this.transitionTo(t, function (t) {
                Mt(t.fullPath), ot(n.router, t, o, !1), e && e(t)
            }, r)
        }, e.prototype.replace = function (t, e, r) {
            var n = this,
                o = this.current;
            this.transitionTo(t, function (t) {
                Vt(t.fullPath), ot(n.router, t, o, !1), e && e(t)
            }, r)
        }, e.prototype.go = function (t) {
            window.history.go(t)
        }, e.prototype.ensureURL = function (t) {
    ...
    function Mt(t) {
        lt ? dt(It(t)) : window.location.hash = t
    }

    function Vt(t) {
        lt ? vt(It(t)) : window.location.replace(It(t))
    }
    var Bt = function (t) {
            function e(e, r) {
        ...
        Ft = function (t) {
            ...
            var e = t.mode || "hash";
            switch (this.fallback = "history" === e && !lt && !1 !== t.fallback, this.fallback && (e = "hash"), K || (e = "abstract"), this.mode = e, e) {
                case "history":
    ...
    return Ft.prototype.match = function (t, e, r) {
        ...
        if (this.apps.push(t), t.$once("hook:destroyed", function () {
                ...
                r > -1 && e.apps.splice(r, 1), e.app === t && (e.app = e.apps[0] || null), e.app || e.history.teardownListeners()
            }), !this.app) {
            this.app = t;
            var r = this.history;
            if (r instanceof $t || r instanceof Tt) {
                var n = function (t) {
                    r.setupListeners(),
                        function (t) {
                            var n = r.current,
                                o = e.options.scrollBehavior;
                            lt && o && "fullPath" in t && ot(e, t, n, !1)
                        }(t)
                };
    ...
    }, Object.defineProperties(Ft.prototype, Ht), Ft.install = function t(r) {
        if (!t.installed || B !== r) {
            t.installed = !0, B = r;
            var n = function (t) {
                    return void 0 !== t
            ...
            r.mixin({
                beforeCreate: function () {
                    n(this.$options.router) ? (this._routerRoot = this, this._router = this.$options.router, this._router.init(this), r.util.defineReactive(this, "_route", this._router.history.current)) : this._routerRoot = this.$parent && this.$parent._routerRoot || this, o(this, this)
                },
                destroyed: function () {
                    o(this)
                }
            }), Object.defineProperty(r.prototype, "$router", {
                get: function () {
                    return this._routerRoot._router
                }
            }), Object.defineProperty(r.prototype, "$route", {
                get: function () {
                    return this._routerRoot._route
                }
            }), r.component("RouterView", e), r.component("RouterLink", z);
            var i = r.config.optionMergeStrategies;
            i.beforeRouteEnter = i.beforeRouteLeave = i.beforeRouteUpdate = i.created
        }
    }, Ft.version = "3.4.3", Ft.isNavigationFailure = kt, Ft.NavigationFailureType = mt, K && window.Vue && window.Vue.use(Ft), Ft
