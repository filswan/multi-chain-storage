...
export default {
  ...
  methods: {
    ...
    toDetail(row){
      ...
      sessionStorage.setItem('dealsPaginationIndexMain', this.parma.offset)
    },
    payClick(row){
      let _this = this
  ...
  mounted() {
    ...
    if(sessionStorage.getItem('dealsPaginationIndexMain')) _this.parma.offset = Number(sessionStorage.getItem('dealsPaginationIndexMain'))
    _this.stats()
