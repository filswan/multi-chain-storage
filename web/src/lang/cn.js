export default {
    ...
    uploadFile: {
        ...
        task_name: '任务名称',
        w3ss_id: "Web3存储服务商",
        w3ss_id_tooltip: '为Filecoin网络提供存储容量的存储提供商。',
        w3ss_id_nothing: '排队',
        w3ss_id_nothing_tooltip: '从这个上传的数据正在聚合存储在Filecoin上。Filecoin交易将在上传48小时内激活。',
        create_time: '创建时间',
        deal_id: '交易ID',
        payment: '支付',
        pay: '支付',
        ...
        detail_Network: '网络',
        detail_Locked_funds: '锁定基金',
        detail_Storage_Price: '存储价格',
        detail_ProposalCID: '建议CID',
        detail_MessageCID: '消息CID',
        detail_PieceCID: '块CID',
        detail_Client_Address: '客户端地址',
        detail_Verified_Deal: '真实数据',
        detail_Storage_Price_Per_Epoch: '每历元存储价格',
        detail_Signature_Type: '签名类型',
        detail_Retrieval_Filecoin: '从Filecoin网络检索',
        detail_Retrieval_Filecoin_tooltip: "该交易在区块链上发布之前不能用于检索。这个命令末尾的'output-file'是您想要保存的文件名，您也可以为这个变量添加一个路径。",
        detail_DAO_Signatures: 'DAO签名',
        detail_DAO_Signatures_tooltip: '这些签名用来解锁提供方的资金。',
        detail_DAO_RKH_Address: 'DAO RKH地址',
        detail_Time: '日期',
        uploadFile_title: '请上传文件并设置存储时间。估算的存储成本将为您计算。',
        Duration: '存储时间',
        Duration_tip: '请输入存储时间',
        Duration_tooltip: '存储时间是指您希望文件在Filecoin网络上存储的期限。',
        Estimated_Storage_Cost: '估算存储成本',
        Estimated_Storage_Cost_tooltip: '估算的存储成本是根据文件大小、设置的存储时间和平均供应商价格计算的。',
        Select_Lock_Funds_Plan: '选择锁定基金计划',
        Select_Lock_Funds_Plan_tooltip: '锁定的资金越多，你的文件就会越早存储在Filecoin网络上。超额支付的资金将在交易链上后自动返回。',
        latest_exchange_rate: 'FIL对于USDC的最新汇率是',
        Low: '低',
        Average: '中等',
        High: '高',
        File_uploading: '文件上传',
