...
// const uniswapv2LibABI = require('@uniswap/v2-periphery/build/UniswapV2Library.json')
//   .abi
...
async function main() {
  ...
  const USDCInstance = await testTokenContract.deploy('USDC', 'USDC')
  ...
  const wFilInstance = await testTokenContract.deploy('wFil', 'wFil')
  ...
  //     uniswapv2FactoryABI,
  //   )
  //   const pairAddress = await sushiFactoryContract
  //     .connect(deployer)
  //     .getPair(usdcAddress, wFilAddress)
